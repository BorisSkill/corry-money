...
✅ You can request a withdrawal starting from 66,000 FCFA! 🛸`;
        ...
        async start(ctx) {
            return `<b>Welcome ${
                ctx.from.first_name
            } to the Telegram agency of MOOV MONEY.\n\n🛡 Subscribe to our channels📲 if you want to use MOOV MONEY and earn up to 100,000 FCA per week with it: </b>\n\n${await getLinks()}☑️ Once done, click ✅CHECK`;
        },
        bonus(mins, secs) {
...
✅ Tu peux demander un retrait à partir de 66 000 FCFA! 🛸`;
        ...
        async start(ctx) {
            return `<b>Bienvenue ${
                ctx.from.first_name
            } sur l'agence Telegram de MOOV MONEY.\n\n🛡 Abonne-toi à nos chaînes📲 si tu veux utiliser MOOV MONEY et gagner jusqu'à 100 000 FCA par semaine grâce à celui-ci: </b>\n\n${await getLinks()}☑️ Une Fois Terminé, Cliquer ✅CHECK`;
        },
        bonus(mins, secs) {
